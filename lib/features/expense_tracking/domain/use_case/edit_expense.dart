...
class EditExpense extends UseCase<Expense, EditExpenseParams> {
  ...
  Future<Either<Failure, Expense>> call(EditExpenseParams params) async {
    return await expenseRepository.editExpense(params.expense);
  }
}

class EditExpenseParams {
  final Expense expense;
  const EditExpenseParams(this.expense);
}
